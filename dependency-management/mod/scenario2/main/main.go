...
import (
	...
	"github.com/muly/golang/dependency-management/mod/scenario2/api"
)
...
cd $GOPATH/src/github.com/muly/golang/dependency-management/mod/scenario2
go mod init github.com/muly/golang/dependency-management/mod/scenario2
go mod vendor
